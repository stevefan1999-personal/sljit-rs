...
fn test_i64_bitwise() {
    ...
    let func = compile_simple(&[], &[ValType::I32], &[], &body_and).expect("Compilation failed");
    ...
    let func_or = compile_simple(&[], &[ValType::I32], &[], &body_or).expect("Compilation failed");
    ...
    let func_xor =
        compile_simple(&[], &[ValType::I32], &[], &body_xor).expect("Compilation failed");
...
fn test_i64_shifts() {
    ...
    let func_shl =
        compile_simple(&[], &[ValType::I32], &[], &body_shl).expect("Compilation failed");
    ...
    let func_shrs =
        compile_simple(&[], &[ValType::I32], &[], &body_shrs).expect("Compilation failed");
    ...
    let func_shru =
        compile_simple(&[], &[ValType::I32], &[], &body_shru).expect("Compilation failed");
...
fn test_i64_extend() {
    ...
    let func_s = compile_simple(&[], &[ValType::I32], &[], &body_s).expect("Compilation failed");
    ...
    let func_u = compile_simple(&[], &[ValType::I32], &[], &body_u).expect("Compilation failed");
...
fn test_f32_eq() {
    ...
    let func2 = compile_simple(&[], &[ValType::I32], &[], &body2).expect("Compilation failed");
